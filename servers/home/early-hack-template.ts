export async function main(ns: NS) {
    ...
    while(true) {
        ...
        ns.printf("Security: %s/%s", ns.formatNumber(security, 2), ns.formatNumber(securityThresh, 2));
        ns.printf("Money: %s/%s", ns.formatNumber(cash, 2), ns.formatNumber(moneyThresh, 2));
